...
A specific [release](https://github.com/JonasWischeropp/unity-shader-graph-modifier/releases) version can be specified by appending `#<version>` (e.g. `...ifier.git#1.0.2`).
